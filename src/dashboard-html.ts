...
async function loadAgents() {
  try {
    ...
    container.innerHTML = data.agents.map(a => {
      ...
      const modelOpts = ['claude-opus-4-8', 'claude-opus-4-7', 'claude-opus-4-6', 'claude-sonnet-4-6', 'claude-sonnet-4-5', 'claude-haiku-4-5'];
      const modelShort = function(m) { return {'claude-opus-4-8':'Opus 4.8','claude-opus-4-7':'Opus 4.7','claude-opus-4-6':'Opus 4.6','claude-sonnet-4-6':'Sonnet','claude-sonnet-4-5':'Sonnet 4.5','claude-haiku-4-5':'Haiku'}[m] || m; };
      const currentModel = a.model || (a.id === 'main' ? 'claude-opus-4-8' : 'claude-opus-4-8');
...
function openCreateAgentWizard() {
  ...
  document.getElementById('caw-model').value = 'claude-opus-4-8';
